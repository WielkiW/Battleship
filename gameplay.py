...
def ship_direction(ship_placment, coords, ship, dimension, board_for_player):
        ...
        while ship_number > 0:
            ...
            if change_coords_to_corect(coords, dimension) == False:
                ...
                if board_for_player[coords[0]][coords[1]] == "X":
                    ...
                    if ship['size'] > 1:
                        ship_direction(ship_placment, coords,
                                       ship, dimension, board_for_player)
                        ship_number -= 1
                    else:
...
def place_ships(board_for_player, dimension, player):
    harbour = game_board.ship_harbour(dimension)
    # list_of_coords = []
    for ship in harbour:
        # list_of_ship = []
