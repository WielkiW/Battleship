...
def main():
    oponent = 'x'
    while oponent == 'x':
        oponent, boards_fleets = menu_battleship(dimension)
    if oponent == 'player':
        game_dev(boards_fleets)
    else:
        player_vs_cpu(boards_fleets)


def game_dev(boards_fleets):
...
def player_vs_cpu():
    ...
    while value_win_player_1 != value_to_win or value_win_ai != value_to_win:
        ...
        time.sleep(3)
        value_win_player_1 = ai.enemy_ai(
        ...
        match menu_operation:
            case 1:
                ...
                if board_for_player_1 == []:
                    ...
                    return 'player', [board_for_player_1, board_for_player_2, player1_fleet, player2_fleet]
            case 3:
                graphix.clear()
                print("Player 1")
            ...
            case 2:
                if board_for_player_1 == []:
                    ...
                    print(board_for_ai)
                    return 'cpu', [board_for_player_1, board_for_ai, player1_fleet, ai_fleet]
            case _:
                try:
